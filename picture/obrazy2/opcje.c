...
typedef struct {
  ...
  int negatyw,progowanie,konturowanie,rozmycie,zmiana_poziomu,maski,wyswietlenie;      /* opcje */
  int w_progu,nr_maski, zm_poz_czern,zm_poz_biel;              /* wartosc progu dla opcji progowanie */ 
} t_opcje;
